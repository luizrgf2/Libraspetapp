...
class Cocovermes_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Cocô com vermes hoje');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Cocô com vermes há dias');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Xixi_Screens()));
                ...
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Cocô com vermes há semanas');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Xixi_Screens()));
