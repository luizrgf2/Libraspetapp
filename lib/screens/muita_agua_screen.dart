...
class MuitaAgua_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Bebeu muita água hoje');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Bebe muita água há dias');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Vomito_Screens()));
                ...
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Bebe muita água há semanas');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Vomito_Screens()));
