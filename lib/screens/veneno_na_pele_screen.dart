...
class Napele_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Veneno na pele hoje');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Veneno na pele há dias');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Comida_Screen()));
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.001,
                      function: () {
                        write_in_file('Veneno na pele há semanas');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Comida_Screen()));
