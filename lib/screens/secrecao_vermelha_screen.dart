...
class SecreVermelha_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Secreção nasal vermelha hoje');
                        Navigator.push(context,
                            MaterialPageRoute(builder: (ctx) => Coco_Screen()));
                      },
                      altura: altura * 0.09,
                      largura: largura * 0.3,
                      text: 'HOJE'),
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Secreção nasal vermelha há dias');
                        Navigator.push(context,
                            MaterialPageRoute(builder: (ctx) => Coco_Screen()));
                      },
                      altura: altura * 0.09,
                ...
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Secreção nasal vermelha há semanas');
                        Navigator.push(context,
                            MaterialPageRoute(builder: (ctx) => Coco_Screen()));
                      },
                      altura: altura * 0.09,
