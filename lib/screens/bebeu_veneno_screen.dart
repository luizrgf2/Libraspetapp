...
class BebeuVeneno_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Bebeu Veneno hoje');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Bebeu veneno há dias');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Comida_Screen()));
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.001,
                      function: () {
                        write_in_file('Bebeu veneno há semanas');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => Comida_Screen()));
