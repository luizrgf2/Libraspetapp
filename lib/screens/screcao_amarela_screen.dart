...
class SecreAmarela_Screen extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Secreção nasal amarela hoje');
                ...
                Expanded(
                  child: Button_text(
                      altura_text: altura * 0.035,
                      function: () {
                        write_in_file('Secreção nasal amarela há dias');
                        Navigator.push(context,
                            MaterialPageRoute(builder: (ctx) => Coco_Screen()));
                      },
                      altura: altura * 0.09,
                ...
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Secreção nasal amarela há semanas');
                        Navigator.push(context,
                            MaterialPageRoute(builder: (ctx) => Coco_Screen()));
                      },
                      altura: altura * 0.09,
