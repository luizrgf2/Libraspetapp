...
class Diarreia_Screen extends StatelessWidget {
  @override
              ...
              children: [
                ...
                Expanded(
                  child: Button_text(
                      ...
                      function: () {
                        write_in_file('Diaréia há semanas');
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => CocoCores_Screen()));
